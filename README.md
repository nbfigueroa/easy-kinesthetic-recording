...
- When recording demonstrations in 'command' mode, the frequency of /lwr/joint_states and /lwr/ee_pose is 500 hz; i.e. dt=0.002
- When recording demonstrations in 'monitor' mode, the frequency of /lwr/joint_states and /lwr/ee_pose is 100 hz; i.e. dt=0.01
